      ...
      <div class="bg-gray-200 px-6 py-4">
        ...
        <div className="flex gap-2 items-center justify-center flex-col md:flex-row">
          <div className="w-4/5 md:w-2/5 ">
            <button className="text-xs w-full  bg-green-700 rounded-lg p-2 text-white font-semibold cursor-pointer">
              Accept
            </button>
          </div>
          <div className="w-4/5 md:w-2/5">
            <button className="text-xs w-full bg-red-600 rounded-lg p-2 text-white font-semibold cursor-pointer">
              Reject
            </button>
          </div>
        </div>
